...
import { heroData, sectionsData, constants, contentData, mentorshipProgramsData } from './MentorshipProgramsPageData';
...
.css-hand-marker.clickable-hover {
  filter: drop-shadow(2px 3px 4px rgba(0, 0, 0, 0.35)) scale(0.96);
}

.css-hand-marker.clickable-hover .marker-tip {
  box-shadow:
...
.dark-theme .screen-surface-inner::after {
  background: radial-gradient(ellipse at 50% 100%,
...
.new-program-card:hover .new-program-icon-wrapper {
...
function ProgramDetail() {
  ...
  return (
    <main className="main-content" style={{ minHeight: '60vh', padding: '40px' }}>
      <button onClick={() => navigate(-1)} className="theme-toggle" style={{ display: 'inline-flex', gap: '8px', padding: '10px 16px', borderRadius: '12px' }}>
