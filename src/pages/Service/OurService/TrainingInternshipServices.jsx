...
const TrainingInternshipServices = () => {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-3xl shadow-xl p-6 md:p-10 mt-6">
          ...
          <p className="text-[#475569] text-lg leading-8">
            We provide hands-on skill development through internship programs
            and specialized training in cyber law, security, and IT.
          </p>
          <button
...
export default TrainingInternshipServices;
