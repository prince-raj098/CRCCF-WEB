...
import { trainingInternshipData } from "../../../data/service/trainingInternshipData";
...
const TrainingHeroOverlay = () => {
  return (
    <g transform="translate(680, 50)">
      <defs>
        <pattern id="tiGrid" width="30" height="30" patternUnits="userSpaceOnUse">
      ...
      <rect width="300" height="300" fill="url(#tiGrid)" />
...
const VideoHeroTraining = ({ src = "" }) => {
  const shouldReduce = useReducedMotion();
  const title = "CRCCF Training Hero";
  ...
  return (
    <svg viewBox="0 0 1000 400" className="w-full h-auto block" role="img" aria-label={title}>
      ...
      <rect width="100%" height="100%" fill={color.slate900} rx="20" />
      <foreignObject x="0" y="0" width="1000" height="400" mask="url(#tiHeroMask)">
        <video
          src={src}
...
export default function TrainingInternshipServices() {
      ...
      >
        ...
        <div ref={heroRef} className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
          <motion.div variants={itemUp}>
            ...
            <p className="text-xl text-slate-600 leading-relaxed max-w-xl">
              CRCCF provides Training and Internship Services in software development, cyber security, cyber awareness, AI, web development, app development, HR, data entry and digital technology domains.Our programs focus on practical learning, real-time project exposure, skill development, mentorship and certification-based professional growth for students, beginners and freshers.
            </p>
          </motion.div>
          ...
          <motion.div style={{ y: heroY }} className="relative">
            ...
            <div className="relative rounded-[40px] border border-gray-200 bg-white p-5 shadow-2xl overflow-hidden">
               <VideoHeroTraining src="https://cdn.coverr.co/videos/coverr-a-man-writing-in-his-notebook-4541/1080p.mp4" />
            </div>
          </motion.div>
        </div>
        ...
        <div className="mt-10 pt-10 border-t border-slate-100">
          <div className="mb-16 text-center">
            <h2 className="text-4xl font-black text-slate-900 mb-4 tracking-tight">Training <span className="text-amber-600">Services</span></h2>
            <p className="text-slate-500 text-lg font-medium">Flip the cover to explore our 60 strategic training programs.</p>
          </div>

          <div className="py-6">
            <InsightBook 
              allPages={trainingInternshipData} 
              bookTitle="Training & Internships"
              bookSubtitle="60 Pillars of Professional Growth"
        ...
        <motion.div variants={itemUp} className="mt-16 text-center">
          <div className="bg-slate-900 rounded-[40px] p-12 md:p-16 relative overflow-hidden shadow-2xl">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-6 relative z-10">Launch Your Career</h3>
            <p className="text-slate-400 text-lg mb-10 max-w-2xl mx-auto relative z-10">Join our internship and training programs to gain practical experience and accelerate your professional growth.</p>
