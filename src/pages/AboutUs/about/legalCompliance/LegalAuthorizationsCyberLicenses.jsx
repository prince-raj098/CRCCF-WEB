...
// Import data
import { legalAuthorizationsData } from '../../../../data/LegalAuthorizationsData';
...
const SVG_Auth = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full">
    <path d="M50 10 L 80 25 V 75 L 50 90 L 20 75 V 25 Z" fill="#DBEAFE" stroke="#2563EB" strokeWidth="2" />
    <circle cx="50" cy="50" r="15" fill="#1E3A8A" />
    <path d="M45 50 L 48 53 L 55 46" stroke="white" strokeWidth="3" fill="none" strokeLinecap="round" />
    <path d="M30 40 L 70 40 M 30 60 L 70 60" stroke="#3B82F6" strokeWidth="1" strokeDasharray="4 2" />
  </svg>
);

const SVG_Forensics = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full">
    <rect x="25" y="20" width="50" height="60" rx="4" fill="#F8FAFC" stroke="#94A3B8" />
    <circle cx="50" cy="45" r="10" stroke="#2563EB" strokeWidth="2" fill="none" />
    <line x1="57" y1="52" x2="65" y2="60" stroke="#2563EB" strokeWidth="3" strokeLinecap="round" />
    <rect x="35" y="70" width="30" height="2" fill="#3B82F6" />
    <rect x="35" y="75" width="20" height="2" fill="#3B82F6" />
  </svg>
);

const SVG_Compliance = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full">
    <circle cx="50" cy="50" r="35" fill="none" stroke="#DBEAFE" strokeWidth="8" />
    <path d="M50 15 A 35 35 0 0 1 85 50" stroke="#2563EB" strokeWidth="8" fill="none" strokeLinecap="round" />
    <path d="M40 50 L 47 57 L 65 42" stroke="#1E3A8A" strokeWidth="6" fill="none" strokeLinecap="round" />
  </svg>
);

const svgMap = {
    "auth-specialized": SVG_Auth,
    "auth-forensics": SVG_Forensics,
    ...
    <div className="flex flex-col gap-6 w-full max-w-2xl mx-auto">
      ...
      >
        ...
        >
          ...
          <p className="text-slate-500 font-bold uppercase tracking-[0.2em] text-[10px] mb-8">Legal Licenses & Forensic Permits</p>

          <div className="flex items-center gap-3 text-[13px] font-black uppercase tracking-[0.15em] mt-auto text-blue-600">
            <span>View Authorizations</span>
      ...
      >
        ...
        <div ref={heroRef} className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
          <motion.div variants={itemUp}>
            ...
            <h1 className="text-5xl md:text-6xl font-black text-slate-900 leading-[1.05] mb-8 tracking-tight">
              Legal <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Authorizations</span> & Licenses
            </h1>
            <p className="text-xl text-slate-600 leading-relaxed max-w-xl">
              We operate under specialized licenses that grant us the legal authority to handle digital evidence, conduct cyber forensics, and assist law enforcement.
            </p>
          </motion.div>
          ...
          <motion.div style={{ y: heroY }} className="relative flex justify-center">
            ...
            <div className="relative w-full max-w-md aspect-square bg-white rounded-[40px] shadow-2xl p-10 flex flex-col items-center justify-center border border-slate-100">
                ...
                <h3 className="text-2xl font-black text-slate-800 mb-2">Licensed Agency</h3>
                <p className="text-slate-500 text-center font-medium">Authorized for secure digital evidence handling and professional forensics.</p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="mt-10 pt-10 border-t border-slate-100">
          <div className="mb-16 text-center">
            <h2 className="text-4xl font-black text-slate-900 mb-4 tracking-tight">The Authorization <span className="text-blue-600">Vault</span></h2>
            <p className="text-slate-500 text-lg font-medium">Flip through our digital vault of legal permits and operational licenses.</p>
          </div>

          <div className="py-6">
            <InsightCard allPages={legalAuthorizationsData} />
          </div>
        </div>
        ...
        <motion.div variants={itemUp} className="mt-20 text-center">
          <div className="bg-slate-900 rounded-[40px] p-12 md:p-16 relative overflow-hidden shadow-2xl">
            ...
            <p className="text-slate-400 text-lg mb-10 max-w-2xl mx-auto relative z-10">Every forensic tool we use and every investigation we lead is backed by our active operational licenses.</p>
            <div className="flex flex-wrap justify-center gap-6 relative z-10">
              <Link to="/contact" className="px-10 py-5 bg-blue-600 text-white rounded-2xl font-bold hover:bg-blue-700 transition-all shadow-xl shadow-blue-900/30 flex items-center gap-2">
                Verify Our Licenses <ArrowRight size={22} />
              </Link>
            </div>
          </div>
        </motion.div>
