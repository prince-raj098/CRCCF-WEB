...
// Import data
import { legalRightsLimitsData } from '../../../../data/aboutUs/legalCompliance/LegalRightsLimitsData';
...
const SVG_Rights = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full">
    <path d="M20 80 L 80 80 M 50 80 V 20 M 30 30 L 70 30" stroke="#1E3A8A" strokeWidth="4" strokeLinecap="round" />
    <circle cx="50" cy="20" r="10" fill="#2563EB" />
    <path d="M35 45 H 65" stroke="#3B82F6" strokeWidth="2" strokeDasharray="4 2" />
  </svg>
);

const SVG_Boundaries = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full">
    <rect x="20" y="20" width="60" height="60" fill="none" stroke="#94A3B8" strokeWidth="2" strokeDasharray="4 4" />
    <circle cx="50" cy="50" r="25" fill="#DBEAFE" stroke="#1E3A8A" strokeWidth="2" />
    <path d="M40 40 L 60 60 M 60 40 L 40 60" stroke="#EF4444" strokeWidth="6" strokeLinecap="round" />
  </svg>
);

const SVG_Ethics = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full">
    <path d="M50 10 L 90 30 V 70 L 50 90 L 10 70 V 30 Z" fill="#EFF6FF" stroke="#3B82F6" strokeWidth="2" />
    <path d="M35 50 L 45 60 L 65 40" stroke="#2563EB" strokeWidth="6" fill="none" strokeLinecap="round" />
    <circle cx="50" cy="50" r="40" stroke="#1E3A8A" strokeWidth="1" strokeDasharray="2 4" fill="none" />
  </svg>
);

const svgMap = {
    "limits-defined": SVG_Rights,
    "limits-boundaries": SVG_Boundaries,
    "limits-accountability": SVG_Ethics,
};
    ...
    <div className="flex flex-col gap-6 w-full max-w-2xl mx-auto">
      ...
      >
        ...
        {allPages.map((page, pageIdx) => {
          ...
          const PageSVG = svgMap[page.id] || SVG_Rights;
            ...
            >
              <div className="flex items-center gap-4 mb-8">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[11px] font-bold text-slate-400 mt-1">Pillar {pageIdx + 1} of {allPages.length}</span>
                </div>
              </div>
        ...
        >
          ...
          <p className="text-slate-500 font-bold uppercase tracking-[0.2em] text-[10px] mb-8">Rights, Responsibilities & Jurisdiction</p>

          <div className="flex items-center gap-3 text-[13px] font-black uppercase tracking-[0.15em] mt-auto text-blue-600">
            <span>Explore Boundaries</span>
...
/* ------------------------------ Main Page ------------------------------ */
export default function LegalRightOperationalLimits() {
      ...
      >
        ...
        <div ref={heroRef} className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
          <motion.div variants={itemUp}>
            ...
            <h1 className="text-5xl md:text-6xl font-black text-slate-900 leading-[1.05] mb-8 tracking-tight">
              Legal <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Rights & Limits</span>
            </h1>
            <p className="text-xl text-slate-600 leading-relaxed max-w-xl">
              We balance our investigative rights with a strict adherence to operational limits, ensuring every action is ethical, lawful, and within our approved jurisdiction.
            </p>
          </motion.div>
          ...
          <motion.div style={{ y: heroY }} className="relative flex justify-center">
            ...
            <div className="relative w-full max-w-md aspect-square bg-white rounded-[40px] shadow-2xl p-10 flex flex-col items-center justify-center border border-slate-100">
                ...
                <h3 className="text-2xl font-black text-slate-800 mb-2">Lawful Bounds</h3>
                <p className="text-slate-500 text-center font-medium">Committed to ethical investigations and strict adherence to cyber law boundaries.</p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="mt-10 pt-10 border-t border-slate-100">
          <div className="mb-16 text-center">
            <h2 className="text-4xl font-black text-slate-900 mb-4 tracking-tight">The Boundary <span className="text-blue-600">Map</span></h2>
            <p className="text-slate-500 text-lg font-medium">Flip through the chapters of our operational framework and legal limits.</p>
          </div>
