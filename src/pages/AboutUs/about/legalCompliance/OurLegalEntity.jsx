...
// Import data
import { ourLegalEntityData } from '../../../../data/OurLegalEntitydata';
      ...
      >
        ...
        <motion.div variants={itemUp} className="mt-20 text-center">
          <div className="bg-slate-900 rounded-[40px] p-12 md:p-16 relative overflow-hidden shadow-2xl">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-6 relative z-10">Institutional Trust</h3>
            <p className="text-slate-400 text-lg mb-10 max-w-2xl mx-auto relative z-10">Our legal status empowers us to take direct action and provide authenticated support to victims and partners alike.</p>
            <div className="flex flex-wrap justify-center gap-6 relative z-10">
              <Link to="/contact" className="px-10 py-5 bg-blue-600 text-white rounded-2xl font-bold hover:bg-blue-700 transition-all shadow-xl shadow-blue-900/30 flex items-center gap-2">
                Contact Legal Desk <ArrowRight size={22} />
              </Link>
            </div>
          </div>
        </motion.div>
