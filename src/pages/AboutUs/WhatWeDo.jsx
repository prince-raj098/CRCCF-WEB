      ...
      >
        <motion.nav variants={itemUp} className="mb-12">
          <button
            ...
            className="inline-flex items-center gap-2 text-slate-800 hover:text-blue-600 transition-colors font-bold text-sm bg-transparent border-none cursor-pointer p-0"
          >
