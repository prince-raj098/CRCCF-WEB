...
import { talentPlacementData } from "../../data/skillDevelopment/TalentPlacementData";

const iconMap = {
  TrendingUp, GraduationCap, Target, ClipboardCheck, BarChart,
  Rocket, Users, Globe, UserCheck, Briefcase, ShieldCheck,
  Handshake, LifeBuoy, FileText
};

const SectionCard = ({ section, index, totalSections }) => {
  const IconComponent = iconMap[section.icon] || FileText;
  
  // Each card is placed in a static flow inside an invisible tracking div (the scroll targets).
  // But wait, the user wants "vertically stacked cards".
  // This means a sticky container where the cards sit on top of each other.
  // We need a wrapper `div` that represents the scroll height for this specific card.
...
const FloatingIconsBackground = () => {
  const icons = [
    { Icon: Laptop, top: '8%', left: '5%', size: 64, delay: 0 },
    ...
    { Icon: Compass, top: '65%', left: '8%', size: 60, delay: 1.5 },
...
// Instead of creating a separate component that takes scrollYProgress of the parent,
// It's cleaner to create the cards inside the main component to easily map scroll ranges.

const TalentPlacementProgram = () => {
  ...
  const totalSections = talentPlacementData.sections.length;
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 pt-4 pb-8 relative z-10">
          ...
          <div className="flex flex-col items-center text-center pb-16 pt-0">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-[4.5rem] font-black text-[#0A1128] leading-[1.1] tracking-tight mb-2">
              TALENT PLACEMENT <br />
              <span className="text-[#3B82F6]">& CAREER PROGRAM</span>
            </h1>
            
            <p className="text-base md:text-xl text-slate-500 max-w-3xl leading-relaxed mt-5 mb-12 font-medium">
              Harnessing the power of precision evaluation and digital innovation to protect your career trajectory and drive professional growth.
            </p>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-14 pt-10 border-t border-slate-100 min-w-[70%]">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-0.5">Eligibility Core</p>
                  <p className="text-[#0A1128] font-bold text-[15px]">Merit Based</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-0.5">Security</p>
                  <p className="text-[#0A1128] font-bold text-[15px]">Guaranteed</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-[#0A1128] font-bold text-[15px]">Immediate</p>
                </div>
              </div>
      ...
      >
        <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-center overflow-hidden py-12 md:py-20">
          ...
          <div className="relative w-full max-w-4xl px-4 md:px-8 flex items-center justify-center h-full z-10">
            ...
            {talentPlacementData.sections.map((section, index) => {
              const IconComponent = iconMap[section.icon] || FileText;
...
export default TalentPlacementProgram;
