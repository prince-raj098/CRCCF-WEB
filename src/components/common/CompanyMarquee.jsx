...
const marqueeItems = [
  ...
  'CR Cyber Crime Foundation',
              ...
              //  the common marquee contrent use in the recruitment portal and rules/policies page, it takes direction as props to decide the direction of animation

const MarqueeContent = () => {
  return (
    // Render the content of the marquee, which includes the company logo and name repeated for a seamless scrolling effect
